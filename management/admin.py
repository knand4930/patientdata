...
class PatientCodingAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id","mrn", "source_key", "source_name", "name", "ref_bill_code_set_name", "ref_bill_code")
...
class PatientHistoryAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id","mrn", "diagnosis_code", "dx_name")
...
class PatientInformationAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id", "log_id", "mrn", "disch_disp_c", "disch_disp", "hosp_admsn_time", "hosp_disch_time", "los", "icu_admin_flag", "surgery_date")
...
class PatientLabsAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id", "log_id", "mrn","enc_type_nm", "lab_code","lab_name", "observation_value","measurement_units", "reference_range","abnormal_flag", "collection_datetime")
...
class PatientLDAAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id", "log_id", "mrn", "description", "properties_display", "site", "placement_instant", "removal_instant", "flo_meas_name", "line_group_name")
...
class PatientPostOPComplicationsAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id", "log_id", "mrn", "element_name", "context_name", "element_abbr", "smrtdta_elem_value")
...
class PatientProcedureEventsAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id", "log_id", "mrn", "event_display_name", "event_time", "note_text")
...
class PatientVisitAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    list_display = ("id", "log_id", "mrn", "diagnosis_code", "dx_name")
